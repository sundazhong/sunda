...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>css/user.css" type="text/css" media="all" />
...
<div class="loading">
    ...
    <div class="loading-avatar"><img src="<%=basePath%>img/avatar@2x.jpg" alt="" width="100" height="100"></div>
...
<div class="home-bg">
    ...
    <img src="<%=basePath%>img/home-bg.jpg" alt="" width="1000" height="667">
...
<div class="section-wrap section-fristpage" data-slide="1"  >
    ...
    <div class="section">
        ...
        <div class="section-content">
            ...
            <p class="fade fade2">欢迎光临jQuery插件库！</p>
    ...
    <div class="section">
        ...
        <div class="about-content clearfix section-content">
            ...
            <div class="introli">
                ...
                <span class="left_icon"><img class="bio-text bio-icon-1" src="<%=basePath%>img/bio-icon-1.png" data-stellar-ratio="0.7" ></span>

                <span class="right_content "><img class="bio-text bio-text-1" src="<%=basePath%>img/bio-text-1.png" data-stellar-ratio="0.7" ></span>

            </div>

            <div class="introli">

                <span class="left_icon"><img class="bio-text bio-icon-2" src="<%=basePath%>img/bio-icon-2.png" data-stellar-ratio="0.7" ></span>

                <span class="right_content"><img class="bio-text bio-text-2" src="<%=basePath%>img/bio-text-2.png" data-stellar-ratio="0.7" ></span>

            </div>

            <div class="introli">

                <span class="left_icon"><img class="bio-text bio-icon-3" src="<%=basePath%>img/bio-icon-3.png" data-stellar-ratio="0.7" ></span>

                <span class="right_content"><img class="bio-text bio-text-3" src="<%=basePath%>img/bio-text-3.png" data-stellar-ratio="0.7" ></span>
            ...
            <div class="works-list clearfix">
                ...
                <div class="works-item first fade fade1">
                    ...
                    <a href="http://www.jq22.com/" target="_blank">
                        ...
                        <img src="<%=basePath%>img/works/yizaojia.jpg" alt="" width="300" height="180">
                ...
                <div class="works-item fade fade2">
                    ...
                    <a href="http://www.jq22.com" target="_blank">
                        ...
                        <img src="<%=basePath%>img/works/91zaojia.jpg" alt="" width="300" height="180">
                ...
                <div class="works-item fade fade3">
                    ...
                    <a href="http://www.jq22.com/" target="_blank">
                        ...
                        <img src="<%=basePath%>img/works/wenku.jpg" alt="" width="300" height="180">
                ...
                <div class="works-item first fade fade4">
                    ...
                    <a href="http://www.jq22.com/" target="_blank">
                        ...
                        <img src="<%=basePath%>img/works/shinedeliver.jpg" alt="" width="300" height="180">
                ...
                <div class="works-item fade fade2">
                    ...
                    <a>
                        ...
                        <img src="<%=basePath%>img/works/wxshop.jpg" alt="" width="300" height="180">
