...
<head>
    ...
    <title>基于SVG超炫爆裂式关闭模态窗口特效</title>
...
<script type="text/javascript" src='<%=basePath%>js/howler.min.js'></script>
<script type="text/javascript" src='<%=basePath%>js/tween.min_1.js'></script>
